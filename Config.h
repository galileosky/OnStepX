...
#define PINMAP                 PerseusPro //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,      <-Req'd
...
#define RETICLE_LED_DEFAULT           255 //    OFF, n. Where n=0..255 (0..100%) activates feature sets default brightness.   Option
...
#define FEATURE1_NAME           "FOC_OUT" // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE1_TEMP                 OFF //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE1_PIN             AUX9_PIN //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
#define FEATURE1_VALUE_DEFAULT        127 //    OFF, ON, n. Where n=0..255 for ANALOG_OUT purpose.                            Adjust
...
#define FEATURE2_NAME           "FOCU_IN" // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE2_TEMP                 OFF //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
#define FEATURE2_PIN             AUX8_PIN //    OFF, AUX for auxiliary pin, n. Where n is the pin#.                           Adjust
