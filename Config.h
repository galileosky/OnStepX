...
#define PINMAP                PerseusMini //OnStepAP//MaxESP4 //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,      <-Req'd
...
#define SERIAL_A_BAUD_DEFAULT        9600 //230400 //   9600, n. Where n=9600,19200,57600,115200,230400,460800 (common baud rates.)    Infreq
#define SERIAL_B_BAUD_DEFAULT      480600 //9600 //   9600, n. Baud rate as above. See (src/pinmaps/) for Serial port assignments.   Infreq
...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE      38400 //23040 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_MICROSTEPS        32 //16 //    OFF, n. Microstep mode when tracking.                                        <-Req'd
#define AXIS1_DRIVER_MICROSTEPS_GOTO    8 //4 //OFF    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option

// for TMC2130, TMC5160, TMC2209, TMC2226 STEP/DIR driver models:
#define AXIS1_DRIVER_IHOLD            OFF //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS1_DRIVER_IRUN             500 //950 //500 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
...
// If runtime axis settings are enabled changes in the section below may be ignored unless you reset to defaults:
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE      38400 //23040 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_MICROSTEPS        32 //16 //    OFF, n. Microstep mode when tracking.                                        <-Req'd
#define AXIS2_DRIVER_MICROSTEPS_GOTO    8 //4 //OFF //    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option

// for TMC2130, TMC5160, TMC2209, TMC2226 STEP/DIR driver models:
#define AXIS2_DRIVER_IHOLD            OFF //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS2_DRIVER_IRUN             500 //950 //500 //    OFF, n, (mA.) Current during tracking, appropriate for stepper/driver/etc.    Option
...
#define STATUS_BUZZER                  ON //2000 //    OFF, ON, n. Where n=100..6000 (Hz freq.) for speaker. ON for piezo buzzer.    Option
#define STATUS_BUZZER_DEFAULT          ON //OFF //    OFF, ON default starts w/buzzer enabled.                                      Option
...
#define ST4_INTERFACE                  ON //OFF //    OFF, ON enables interface. <= 1X guides unless hand control mode.             Option
...
#define GUIDE_TIME_LIMIT                0 //10 //     10, n. Time limit n=0..120 seconds. Use 0 to disable.                        Adjust
...
#define SLEW_RATE_BASE_DESIRED        1.4 //2.7 //2.0 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS3_DRIVER_MODEL            OFF //TMC2130 //    OFF, Enter motor driver model (above) to activate the rotator.                Option
...
#define AXIS4_DRIVER_MODEL            OFF //TMC2130 //    OFF, Enter motor driver model (above) to activate the focuser.                Option
